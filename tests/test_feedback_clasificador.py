...
Un veredicto por cuestionario: si el analisis del modelo es correcto o
incorrecto. Cubre por HTTP: votar, cambiar de opinion, deshacer, que los
conteos y las metricas globales cuadren, y que una psicologa ajena no
pueda votar sobre una aplicacion que no es suya.
