...
const routes = [
  ...
  { path: '/mi-historial', name: 'mi-historial', component: MiHistorialView, meta: { requiereAuth: true, requiereConsent: true, roles: ['estudiante'] } },
  ...
  { path: '/admin/sistema', name: 'admin-sistema', component: AdminSystemView, meta: { requiereAuth: true, requiereConsent: true, roles: ['admin'] } },
  // Sprint 7 (estudiante)
  { path: '/encuesta', name: 'encuesta', component: SatisfactionSurveyView, meta: { requiereAuth: true, requiereConsent: true, roles: ['estudiante'] } },
  // Sprint 8 (admin)
  { path: '/admin/contenidos', name: 'admin-contenidos', component: AdminContentView, meta: { requiereAuth: true, requiereConsent: true, roles: ['admin'] } },
  { path: '/admin/mensajes-chatbot', name: 'admin-mensajes-chatbot', component: AdminChatbotMessagesView, meta: { requiereAuth: true, requiereConsent: true, roles: ['admin'] } },
  { path: '/admin/reportes', name: 'admin-reportes', component: AdminReportsView, meta: { requiereAuth: true, requiereConsent: true, roles: ['admin'] } },
  { path: '/admin/logs', name: 'admin-logs', component: AdminLogsView, meta: { requiereAuth: true, requiereConsent: true, roles: ['admin'] } },
]
