    ...
    <div v-else-if="data" class="space-y-6">
      ...
      <section class="card overflow-hidden fade-in-up">
        ...
        <p
          ...
          class="text-ink-500 text-center py-10"
        >
          Este estudiante todavía no ha hecho una evaluación.
        </p>
          ...
          <li v-for="s in data.sesiones" :key="s.session_id">
            ...
            >
              <div v-if="s.explicacion" class="card-pastel p-4 mt-4">
                <p
                  class="text-xs font-bold text-green-700 uppercase tracking-wider mb-1"
                >
                  Explicación clínica
                </p>
                <p class="text-sm text-ink-800 whitespace-pre-wrap">
                  {{ s.explicacion }}
                </p>
              </div>
