...
const CAMPOS = [
  ...
  {
    clave: "tagline",
    label: "Tagline del header",
    rows: 1,
    hint: "Texto secundario visible en el chat.",
  },
  {
    clave: "saludo_inicial",
    label: "Saludo inicial (apertura)",
    rows: 5,
    hint: "Usa {nombre} para insertar el nombre del estudiante.",
  },
  {
    clave: "cierre_resultados",
    label: "Mensaje antes de mostrar resultados",
    rows: 2,
    hint: "",
  },
...
async function cargar() {
  try {
    mensajes.value = await api.getChatbotMessages();
  } catch (e) {
...
<template>
  <div class="page-shell">
    ...
    <PageHeader
      title="Mensajes de Sami"
      subtitle="Edita el texto que Sami usa cuando habla con los estudiantes."
      tone="peach"
    />
    ...
    <div v-else class="space-y-4 fade-in-up">
      ...
      <p v-if="guardado" class="banner-success">Cambios guardados.</p>
